...
?>
      ...
      <div class=" container h-100"  >
                    ...
                    <form>
                      ...
                      <div class="form-check d-flex p-0 justify-content-center "  >
                        ...
                        <div class="form-check d-flex p-0 justify-content-center " >
                            <p class="mt-1 mb-0" style="justify-text:center; justify-self: center; font-size: 17px; font-weight: 100; color: gray; font-family: Arial, Helvetica, sans-serif; text-transform: lowercase;">
                            <?php
                            $username = "root";
                            $password = "";
                            $servername = "localhost";
                            ...
                            $result = $conn->query("SELECT `USERNAME`,`CAPTION` FROM `users` WHERE `UID`=$userid");
                            if($result->num_rows > 0){ 
                        ...
                        <div class="form-check d-flex p-0 justify-content-center " >
                            <p class=" mb-0" style="margin-top:-15px; justify-text:center; justify-self: center; font-size: 17px; font-weight: 100; color: gray; font-family: Arial, Helvetica, sans-serif; text-transform: lowercase;">
                            <?php
                            $username = "root";
                            $password = "";
                            $servername = "localhost";
  ...
  <div class="d-flex justify-content-center " style="margin-top: 30px; ">
    <a style=" width: 19%; "href="edit.php">
        <input value="Edit Profile" type="button" style=" height: 40px; font-size: 16px; font-weight: 600; width: 100%;">
      </a>
      <a style=" width: 6%;"href="post.php">
        <input value="+" type="button" style="margin-left: 10px; height: 40px; font-size: 18px; font-weight: 600; width: 100%;">
      </a>
</div>
