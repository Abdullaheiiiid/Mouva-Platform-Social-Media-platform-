...
<form action="uploadprofile.php" method="post" enctype="multipart/form-data" class="container" >
    <header class="header">
    ...
    <ul class="user-list2 file d-flex mb-4 " style="justify-content:center ; height:100%;">
      <li style="width: 50%;">
        <input class="form-control " placeholder="Write a bio" style="width:100% ;" id="caption" name="caption3"></textarea>
      </li>
    </ul>
</form>
  <footer id="footer">  
