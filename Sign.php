        ...
        <div class="W-100">
            ...
            <div class="row justify-content-center">
              <div class="W-100 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4"style="color: black;">Sign In</p>

                <form class="mx-1 mx-md-4" action="signincheck.php" method="post">
                  ...
                  <div class="form-check d-flex justify-content-center " >
                      <label class="form-check-label " style="font-family: sans-serif; color: rgb(83, 83, 83);" for="form2Example3">
                        <a class="" style="text-decoration: none; color: black;"href="#">Forget Password?</a>
                        <p> </p>
                        Not a member? <a class=""  style=" text-decoration: none; color: black;"href="registration.php">Sign Up</a>
                      </label>
                    </div>
